...
extensions = [
    ...
    "sphinx_math_dollar", # $math$ for mathjax
]


# -- Extension Options --------------------------------------------------------
# Configure OpenGraph support
ogp_site_url = "https://hsc-physics.readthedocs.io"
ogp_site_name = "HSC Physics Notes"
...
# -- Various Helper Bits -----------------------------------------------------
rst_epilog = """
.. |syllabus-nesa| replace:: --Physics Stage 6 Syllabus, NESA
.. _syllabus-nesa: https://educationstandards.nsw.edu.au/wps/portal/nesa/11-12/stage-6-learning-areas/stage-6-science/physics-2017
"""
